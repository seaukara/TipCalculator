...
//OnCheckedChangeListener, OnItemSelectedListener, OnKeyListener {
    ...
    private int split = 1;
    private float tipAmount = .15f;
    private float totalAmount  = .15f;
    private float splitAmount = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        roundingRadioGroup.setOnCheckedChangeListener(radioButtonListener);
        roundingRadioGroup.setOnKeyListener(keyListener);
        splitSpinner.setOnItemSelectedListener(itemSelectedListener);
    ...
    public void onPause() {
        ...
        editor.putFloat("tipAmount", tipAmount);
        editor.putFloat("totalAmount", totalAmount);
        editor.putFloat("splitAmount",splitAmount);
        editor.commit();
    ...
    public void onResume() {
        ...
        tipAmount = savedValues.getFloat("tipAmount", 0.15f);
        totalAmount = savedValues.getFloat("totalAmount", 0.15f);
        splitAmount = savedValues.getFloat("splitAmount", 0.15f);
